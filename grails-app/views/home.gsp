...
<g:if test="${session.rol == "clienteApp"}">
    <g:link class="btn btn-primary btn-lg" controller="Vehiculo" action="createApp">Registrar Vehiculo</g:link>
    <g:link class="btn btn-primary btn-lg" controller="Vehiculo" action="indexApp">Mis Vehiculos</g:link>
</g:if>
<g:else>

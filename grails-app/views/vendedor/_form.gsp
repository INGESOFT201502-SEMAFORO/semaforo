...
<div class="fieldcontain ${hasErrors(bean: vendedorInstance, field: 'nombre', 'error')} required">
	...
	<g:textField class="form-control" name="nombre" maxlength="50" required="" value="${vendedorInstance?.nombre}"/>
...
<div class="fieldcontain ${hasErrors(bean: vendedorInstance, field: 'usuario', 'error')} required">
	...
	<g:textField class="form-control" name="usuario" maxlength="50" required="" value="${vendedorInstance?.usuario}"/>
...
<div class="fieldcontain ${hasErrors(bean: vendedorInstance, field: 'correo', 'error')} required">
	...
	<g:textField class="form-control" name="correo" maxlength="50" required="" value="${vendedorInstance?.correo}"/>
</div>
</div>
...
<div class="fieldcontain ${hasErrors(bean: vendedorInstance, field: 'password', 'error')} required">
	...
	<g:textField class="form-control" name="password" required="" value="${vendedorInstance?.password}"/>
</div>
</div>
...
<div class="fieldcontain ${hasErrors(bean: vendedorInstance, field: 'edad', 'error')} required">
	...
	<g:field class="form-control" name="edad" type="number" min="18" value="${vendedorInstance.edad}" required=""/>
</div>
</div>
...
<div class="fieldcontain ${hasErrors(bean: vendedorInstance, field: 'cedula', 'error')} required">
	...
	<g:field class="form-control" name="cedula" type="number" value="${vendedorInstance.cedula}" required=""/>
</div>
</div>
...
<div class="fieldcontain ${hasErrors(bean: vendedorInstance, field: 'salario', 'error')} required">
	...
	<g:field class="form-control" name="salario" value="${fieldValue(bean: vendedorInstance, field: 'salario')}" required=""/>
</div>
</div>
